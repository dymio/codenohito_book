...
* [ ] выставить [требования к дизайну](design_requirements.md) дизайнеру:
...
* [ ] разместить старую версию сайта или её статичный слепок на поддомене (old, 2013 и т.п.)

* [ ] проверить, нет ли ссылок на staging или dev версии сайта

* [ ] проверить настройки на наличие временных данных (email разработчика вместо менеджерского в уведомлениях, например)
...
* [ ] зарегистрировать сайт в Яндекс или Google вебмастере
...
* [ ] мониторим работоспособность сайта ([Uptime robot](http://www.uptimerobot.com/), [GotSiteMonitor.com](http://www.gotsitemonitor.com/)), если эта услуга предоставляется

* [ ] настроить автобэкап, если эта услуга предоставляется
